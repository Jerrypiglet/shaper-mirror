...
from shaper_histo.models import build_model
from shaper.solver import build_optimizer
from shaper_histo.data import build_dataloader
...
# from shaper_compare.engine.trainer import train_model, validate_model, train
...
def train(cfg, output_dir=""):
    ...
    if "Histo" in cfg.DATASET.TYPE and not resume_success:
        start_epoch = 0
        best_metric = None
    else:
