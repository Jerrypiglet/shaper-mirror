...
def build_dataset(cfg, mode="train"):
    ...
    if cfg.DATASET.TYPE == "ModelNetHisto":
        if mode == "train":
            dataset = ModelNetCompare(root_dir=cfg.DATASET.ROOT_DIR,
                                      ...
                                      batch_target_num=cfg.DATASET.HISTO.TRAIN_BATCH_TARGET_NUM,
                                      num_per_class=cfg.DATASET.HISTO.NUM_PER_CLASS,
                                      cross_num=cfg.DATASET.HISTO.CROSS_NUM,
            ...
            dataset = ModelNetCompare(root_dir=cfg.DATASET.ROOT_DIR,
                                      ...
                                      class_num_per_batch=cfg.DATASET.HISTO.CLASS_NUM_PER_BATCH,
                                      batch_support_num_per_class=cfg.DATASET.HISTO.BATCH_SUPPORT_NUM_PER_CLASS,
                                      batch_target_num=cfg.DATASET.HISTO.VAL_BATCH_TARGET_NUM,
                                      num_per_class=cfg.DATASET.HISTO.NUM_PER_CLASS,
                                      cross_num=cfg.DATASET.HISTO.CROSS_NUM,
                                      shuffle_data=is_train,
                                      shuffle_points=is_train,
            ...
            dataset = ModelNetCompare(root_dir=cfg.DATASET.ROOT_DIR,
                                      ...
                                      class_num_per_batch=cfg.DATASET.HISTO.CLASS_NUM_PER_BATCH,
                                      batch_support_num_per_class=cfg.DATASET.HISTO.BATCH_SUPPORT_NUM_PER_CLASS,
                                      batch_target_num=cfg.DATASET.HISTO.TEST_BATCH_TARGET_NUM,
                                      num_per_class=cfg.DATASET.HISTO.NUM_PER_CLASS,
                                      cross_num=cfg.DATASET.HISTO.CROSS_NUM,
                                      shuffle_data=is_train,
                                      shuffle_points=is_train,
                                      ...
                                      transform=transform,
                                      use_normal=cfg.INPUT.USE_NORMAL)
    elif cfg.DATASET.TYPE == "ShapeNet55Histo":
        if mode == "train":
...
if __name__ == "__main__":
    ...
    cfg.merge_from_file(
        "/home/rayc/Projects/shaper/configs/modelnet40/histo_net/pointnet/pointnet_source_cls_without_dir.yaml")
