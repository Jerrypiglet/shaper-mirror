...
from tools.ensemble_fewshot_test_net import cfg, ensemble_test
...
if __name__ == "__main__":
    ...
    if cross_num > 0:
        ...
        cross_num = 1
        overall_acc, per_class_acc, overall_acc_collection, per_class_acc_collection,true_positive_per_class_stat = ensemble_test(args, cfg)
        overall_acc_list.append(overall_acc)
        per_class_acc_list.append(per_class_acc)
        overall_acc_collection_list.append(overall_acc_collection)
        logger.info(output_dir_batch_ensemble)
