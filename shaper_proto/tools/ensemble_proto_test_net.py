...
from shaper_proto.engine.tester import test
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="PyTorch 3D Deep Learning Testing For ProtoNet Ensemble")
    parser.add_argument(
        "--cfg",
        dest="config_file",
        default="/home/rayc/Projects/shaper/configs/modelnet40/proto_net/pointnet/pointnet_target_best.yaml",
        metavar="FILE",
