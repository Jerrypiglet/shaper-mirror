...
# 11 classes for few-shot
# ["Bathtub", "Bottle", "Bus", "Cell", "Clock", "Display", "Faucet", "Guitar", "Jar", "Pot", "Telephone"]
FEWSHOT_LABEL_INDS = [4, 9, 11, 17, 19, 22, 24, 26, 28, 41, 50]
...
def set_fewshot_label(origin_label, fewshot_label_inds):
    ...
    Args:
        ...
        fewshot_label_inds: int, list (11,), class indices of few shot categories
...
class ShapeNet55FewShotGenerator(object):
    ...
    def generate_train_dataset(self):
        ...
        with open(osp.join(self.target_dir, 'train_files.txt'), 'w') as f:
            f.write(osp.join(self.target_dir, train_h5_file_path))
    ...
    def generate_valid_dataset(self):
        ...
        with open(osp.join(self.target_dir, 'valid_files.txt'), 'w') as f:
            f.write(osp.join(self.target_dir, valid_h5_file_path))
    ...
    def generate_support_dataset(self):
        ...
        with open(osp.join(self.target_dir, 'support_all_files.txt'), 'w') as f:
            f.write(osp.join(self.target_dir, support_all_h5_file_path))
        ...
        for i in range(self.cross_num):
            ...
            with open(osp.join(self.target_dir,
                ...
                f.write(osp.join(self.target_dir, support_h5_file_path))
    ...
    def generate_target_dataset(self):
        ...
        with open(osp.join(self.target_dir, 'target_files.txt'), 'w') as f:
            f.write(osp.join(self.target_dir, target_h5_file_path))
        print('Generate target dataset finish.')
        print('Total {} models.'.format(target_data.shape[0]))


if __name__ == "__main__":
    SOURCE_DIR = "/home/rayc/Projects/shaper/data/shapenet55_h5"
