...
class ShapeNet55FewShot(Dataset):
    ...
    dataset_map = {
        ...
        "support_all": "support_all_files.txt",
    ...
    def __init__(self, root_dir, dataset_names, num_per_class=1,
        ...
        elif self.dataset_name in ["support", "support_all", "target"]:
...
if __name__ == "__main__":
    root_dir = "/home/rayc/Projects/shaper/data/shapenet55_h5/shapenet55_fewshot"
    modelnet = ShapeNet55FewShot(root_dir, ['target'], cross_num=2)
