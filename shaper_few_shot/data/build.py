...
def build_dataset(cfg, mode="train"):
    ...
    if cfg.DATASET.TYPE == "ModelNetFewShot":
        dataset = ModelNetFewShot(root_dir=cfg.DATASET.ROOT_DIR,
                                  dataset_names=dataset_names,
                                  num_per_class=cfg.DATASET.FEW_SHOT.NUM_PER_CLASS,
                                  cross_num=cfg.DATASET.FEW_SHOT.CROSS_NUM,
                                  shuffle_points=is_train,
                                  num_points=cfg.INPUT.NUM_POINTS,
                                  transform=transform,
                                  use_normal=cfg.INPUT.USE_NORMAL)
    elif cfg.DATASET.TYPE == "ShapeNetFewShot":
