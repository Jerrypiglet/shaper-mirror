...
from shaper.models.pn2_modules._ext import pointnet2
...
class BallQuery(Function):
    ...
    def forward(
        ...
        pts_cnt: toch.Tensor
            (B, npoint) number of unique points in each ball group
        """
...
class QueryAndGroup(nn.Module):
    ...
    def forward(
        ...
        idx, _ = ball_query(self.radius, self.nsample, xyz, new_xyz)
...
class QueryAndGroupWithCnt(nn.Module):
    r"""
    Groups with a ball query of radius
