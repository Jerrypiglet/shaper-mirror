...
class PointNet2SSGTwoBranch(nn.Module):
    ...
    def __init__(self,
        ...
        Args:
            ...
            num_global_output (int): number of global outputs
            num_mask_output (int): the number of point-wise outputs
        ...
        """
        super(PointNet2SSGTwoBranch, self).__init__()
        ...
        if num_mask_output > 0:
            ...
            self.mask_output = nn.Conv1d(seg_channels[-1], num_mask_output, 1, bias=True)
    ...
    def forward(self, data_batch):
        ...
        if self.num_global_output > 0:
            x = self.mlp_global(global_feature)

            preds['global_output'] = self.global_output(x)
        ...
        if self.num_mask_output > 0:
            ...
            preds['mask_output'] = self.mask_output(x)
