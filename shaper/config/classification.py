...
_C.MODEL.PN2SSG.TRANSFORM = False
...
_C.MODEL.PNS2CNN = CN()
_C.MODEL.PNS2CNN.NUM_CENTROIDS = 1024
_C.MODEL.PNS2CNN.RADIUS_LIST = (0.3,)
_C.MODEL.PNS2CNN.NUM_NEIGHBOURS_LIST = (48,)
_C.MODEL.PNS2CNN.BAND_WIDTH_IN_LIST = (8,)
_C.MODEL.PNS2CNN.FEATURE_CHANNELS_LIST = ((16, 16, 32),)
_C.MODEL.PNS2CNN.BAND_WIDTH_LIST = ((8, 8, 4),)
_C.MODEL.PNS2CNN.K = 20
_C.MODEL.PNS2CNN.LOCAL_CHANNELS = (256, 512, 1024,)
_C.MODEL.PNS2CNN.GLOBAL_CHANNELS = (512, 256)
_C.MODEL.PNS2CNN.DROPOUT_PROB = 0.5
