...
_C.MODEL.S2CNN.BAND_WIDTH_IN = 64
...
# Local pointnet paras
_C.MODEL.DGS2CNN.NUM_POINTS = 256
_C.MODEL.DGS2CNN.RADIUS_LIST = (0.2,)
_C.MODEL.DGS2CNN.NUM_SAMPLE_LIST = (64,)

# Local S2CNN paras
_C.MODEL.DGS2CNN.BAND_WIDTH_IN_LIST = (64,)
_C.MODEL.DGS2CNN.FEATURE_CHANNELS_LIST = ((32, 32, 64, 64),)
_C.MODEL.DGS2CNN.BAND_WIDTH_LIST = ((32, 32, 16, 16),)
...
# Local pointnet paras
_C.MODEL.PNS2CNN.NUM_POINTS = 256
_C.MODEL.PNS2CNN.RADIUS_LIST = (0.2,)
_C.MODEL.PNS2CNN.NUM_SAMPLE_LIST = (64,)

# Local S2CNN paras
_C.MODEL.PNS2CNN.BAND_WIDTH_IN_LIST = (64,)
_C.MODEL.PNS2CNN.FEATURE_CHANNELS_LIST = ((32, 32, 64, 64),)
_C.MODEL.PNS2CNN.BAND_WIDTH_LIST = ((32, 32, 16, 16),)

# Global pointnet paras
_C.MODEL.PNS2CNN.K = 20
_C.MODEL.PNS2CNN.GLOBAL_CHANNELS = (256, 512)
_C.MODEL.PNS2CNN.FC_CHANNELS = (512, 256)
_C.MODEL.PNS2CNN.DROP_PROB = 0.5
_C.MODEL.PNS2CNN.TRANSFORM_XYZ = True
_C.MODEL.PNS2CNN.TRANS_REG_WEIGHT = 0.0
